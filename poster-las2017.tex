...
\block{Application: Certifying the Digital Competencies of French citizens}{
  \begin{minipage}[b]{0.36\linewidth}
    ...
    \end{minipage}
    \begin{minipage}[b]{0.36\linewidth}
      \centerline{\raisebox{-0cm}{\includegraphics[width=0.9\linewidth]{figures/pix.png}}}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.08\linewidth}
      \centering
    \includegraphics[width=0.8\textwidth]{figures/logo-uga.jpg}\\[1em]
    \includegraphics[width=0.7\textwidth]{figures/logo-riken.png}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.08\linewidth}
      \centering
