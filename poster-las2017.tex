...
\end{array}\right. \]
    ...
    \block{Can we do better?}{
        \innerblock[]{Our Heuristic Method}{ %\smash{
            ...
            \[ \Pr(\textsf{correct}_{ij}) \textnormal{ is the same as in Item Response Theory} \]
...
\block{Application: Certifying the Digital Competencies of French citizens}{
    ...
    \begin{minipage}{0.15\linewidth}
        \includegraphics[width=0.8\linewidth]{figures/logo-pix.pdf}
    \end{minipage}
    \hfill
    % Logos
    \begin{minipage}{0.1\linewidth}
        \raggedleft
        \includegraphics[width=0.75\linewidth]{figures/logo-uga.jpg}\\[0.5em]
        \includegraphics[width=0.65\linewidth]{figures/logo-riken.png}
    \end{minipage}
    \begin{minipage}{0.1\linewidth}
        \raggedleft
        \includegraphics[width=0.75\linewidth]{figures/logo-ensps.jpg}\\[0.5em]
        \includegraphics[width=0.75\linewidth]{figures/logo-lri.pdf}
    \end{minipage}
    \begin{minipage}{0.1\linewidth}
        \raggedleft
        \includegraphics[width=0.75\linewidth]{figures/logo-cs.png}\\[0.5em]
        \includegraphics[width=0.75\linewidth]{figures/logo-men.pdf}
    \end{minipage}
}
