...
\end{array}\right. \]
    ...
    \block{Input: Dependency Graph over DIGCOMP 2.0}{
        Nodes: \textbf{800 knowledge components} of difficulty 1–6\\
        Edges are prerequisites ($u \rightarrow v$ $\iff$ $u$ should be mastered before $v$)
        ...
        Each question is mapped to a knowledge component.
...
\block{Greedy Selection}{
    If the estimated level of the learner $\hat{\theta}_i$ is $2$, then:\\
...
\block{Application: Certifying the Digital Competencies of French citizens}{
    % \begin{wrapfigure}{r}{0.2\colwidth}
    ...
    \begin{itemize}
        ...
        \item Output: 3 adaptive tests of \textbf{20 questions}
        \item So far, \textbf{514731 collected answers} in the database
    \end{itemize}
